...
exports.MultizonePeoplePresenceAggregated01Payload = exports.IdTagsPart = void 0;
...
exports.MultizonePeoplePresenceAggregated01Payload = (() => {
    let _classDecorators_1 = [(0, client_1.PluginPayload)('MULTIZONE_PEOPLE_PRESENCE_AGGREGATED_01')];
    ...
    var MultizonePeoplePresenceAggregated01Payload = _classThis_1 = class {
        constructor() {
    ...
    __setFunctionName(_classThis_1, "MultizonePeoplePresenceAggregated01Payload");
    (() => {
        _instanceId_decorators = [(0, client_1.Bind)('INSTANCE_ID')];
        _idTags_decorators = [Embedded(IdTagsPart, 'ID_TAGS')];
        ...
        MultizonePeoplePresenceAggregated01Payload = _classThis_1 = _classDescriptor_1.value;
        __runInitializers(_classThis_1, _classExtraInitializers_1);
    })();
    return MultizonePeoplePresenceAggregated01Payload = _classThis_1;
})();
